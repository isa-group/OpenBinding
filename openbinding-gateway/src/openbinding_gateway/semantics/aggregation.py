"""Application model, aggregation part (Lambda of M_A = (T, G, Lambda)).

How a feature composes along the workflow: sum down a sequence, max across a
fork, probability-weighted across an exclusive choice, repeated around a loop.
Pure functions of the composition and the selected candidates.
"""
