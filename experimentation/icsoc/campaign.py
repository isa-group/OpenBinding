"""Resumable experiment runner for the PI4SecFaaS2Fog placement campaign.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run the PI4SecFaaS2Fog placement campaign")
